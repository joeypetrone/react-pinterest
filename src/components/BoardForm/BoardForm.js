    ...
    return (
      <div className="BoardForm">
        <form className="col-6 offset-3 bg-white rounded mb-3 p-2">
          ...
          { isEditing
            ? <button type="button" className="btn btn-dark" onClick={this.updateBoard}>Update Board</button>
            : <button type="button" className="btn btn-dark" onClick={this.saveBoard}>Save Board</button>
          }
